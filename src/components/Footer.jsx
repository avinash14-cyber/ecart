...
const Footer = () => {
  ...
  <Link to={'/history'} style={{textDecoration:'none',color:'white'}}>History Page</Link>   
     ...
     <div className='flex flex-col'>
   <h5 className='text-xl'>Guides</h5>
   ...
   <input type="text" placeholder='Enter your email' className='rounded p-1' />
    <button className='btn btn-info ms-2'><i className='fa-solid fa-arrow-right'></i></button>
     ...
     <a href="https://en.wikipedia.org/wiki/Twitter" style={{textDecoration:'none',color:'white'}} target='_blank'><i className='fa-brands fa-twitter'></i></a>
          <a href="https://en.wikipedia.org/wiki/Twitter" style={{textDecoration:'none',color:'white'}} target='_blank'><i className='fa-brands fa-instagram'></i></a>
               <a href="https://en.wikipedia.org/wiki/Twitter" style={{textDecoration:'none',color:'white'}} target='_blank'><i className='fa-brands fa-facebook'></i></a>
           <a href="https://en.wikipedia.org/wiki/Twitter" style={{textDecoration:'none',color:'white'}} target='_blank'><i className='fa-brands fa-linkedin'></i></a>         
                 <a href="https://en.wikipedia.org/wiki/Twitter" style={{textDecoration:'none',color:'white'}} target='_blank'><i className='fa-brands fa-github'></i></a>

                      <a href="https://en.wikipedia.org/wiki/Twitter" style={{textDecoration:'none',color:'white'}} target='_blank'><i className='fa-solid fa-phone'></i></a>
     </div>
     </div>
     </div>
     <p className='text-center mt-3 text-white'>Copyright &copy; May 2025, E-cart.Built with React/Redux</p>
    </div>
  )
}
